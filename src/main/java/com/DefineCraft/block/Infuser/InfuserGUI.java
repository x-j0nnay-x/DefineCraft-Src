...
{
    private static final ResourceLocation furnaceGuiTextures = new ResourceLocation("DefineCraft:textures/gui/Infuser.png");
    private InfuserLogic logic;

    public InfuserGUI(InventoryPlayer par1InventoryPlayer, InfuserLogic par2TileEntityFurnace)
    {
