...
public class InfuserLogic extends TileEntityFurnace
{
    ...
    {
        return this.isInvNameLocalized() ? this.field_94130_e : "Infuser";
    }
    ...
    private boolean canSmelt ()
    {
        ...
        {
        	ItemStack itemstack = InfuserRecipes.Grinding().getGrindingResult(this.inventory[0]);
            if (itemstack == null)
                return false;
