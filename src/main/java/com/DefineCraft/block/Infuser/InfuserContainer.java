...
{
    private InfuserLogic furnace;
    private int lastCookTime;
    private int lastBurnTime;
    private int lastItemBurnTime;

    public InfuserContainer(InventoryPlayer par1InventoryPlayer, InfuserLogic par2TileEntityFurnace)
    {
    ...
    public ItemStack transferStackInSlot(EntityPlayer par1EntityPlayer, int par2)
    {
        ...
        if (slot != null && slot.getHasStack())
        {
            ...
            {
                if (InfuserRecipes.Grinding().getGrindingResult(itemstack1) != null)
                {
                ...
                else if (InfuserLogic.isItemFuel(itemstack1))
                {
