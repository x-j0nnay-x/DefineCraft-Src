...
public class RefinedWoodenDoorBlock extends Block
{
    private IIcon[] field_150017_a;
    private IIcon[] field_150016_b;
    private static final String __OBFID = "CL_00000230";

    public RefinedWoodenDoorBlock(Material p_i45402_1_)
    {
        super(p_i45402_1_);
        float var2 = 0.5F;
        float var3 = 1.0F;
    ...
    public void registerBlockIcons(IIconRegister p_149651_1_)
    {
        ...
        this.field_150017_a[0] = p_149651_1_.registerIcon(Ref.MODID + ":" + "RefinedWoodenDoorBlock" + "_upper");
        this.field_150016_b[0] = p_149651_1_.registerIcon(Ref.MODID + ":" + "RefinedWoodenDoorBlock" + "_lower");
