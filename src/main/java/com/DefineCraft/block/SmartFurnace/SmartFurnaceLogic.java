...
public class SmartFurnaceLogic extends TileEntityFurnace
{
    ...
    {
        return this.isInvNameLocalized() ? this.field_94130_e : "Smart Furnace";
    }
    ...
    public void readFromNBT (NBTTagCompound par1NBTTagCompound)
    {
        ...
        this.currentItemBurnTime = getItemBurnTime(this.inventory[1]) * 2;
    ...
    public void updateEntity ()
    {
        ...
        if (!this.worldObj.isRemote)
        {
            ...
            {
                this.currentItemBurnTime = this.furnaceBurnTime = getItemBurnTime(this.inventory[1]) * 2;
	...
	public static int getItemBurnTime(ItemStack itemstack){
		if(itemstack == null){
			...
			if (item instanceof ItemBlock && Block.getBlockFromItem(item) != Blocks.air)
            {
	            ...
	            if (var2 == Blocks.sapling)return 150;
