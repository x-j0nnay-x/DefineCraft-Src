...
public class SmartFurnaceGUI extends GuiContainer
{
    private static final ResourceLocation furnaceGuiTextures = new ResourceLocation("DefineCraft:textures/gui/Furnace.png");
    private SmartFurnaceLogic logic;

    public SmartFurnaceGUI(InventoryPlayer par1InventoryPlayer, SmartFurnaceLogic par2TileEntityFurnace)
    {
