...
public class BarMakerLogic extends TileEntityFurnace
{
    ...
    {
        return this.isInvNameLocalized() ? this.field_94130_e : "Bar Maker";
    }
    ...
    {
        return this.furnaceCookTime * par1 / 10;
    }
