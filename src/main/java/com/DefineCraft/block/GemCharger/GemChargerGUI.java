...
public class GemChargerGUI extends GuiContainer
{
    private static final ResourceLocation furnaceGuiTextures = new ResourceLocation("DefineCraft:textures/gui/GemCharger.png");
    private GemChargerLogic logic;

    public GemChargerGUI(InventoryPlayer par1InventoryPlayer, GemChargerLogic par2TileEntityFurnace)
    {
