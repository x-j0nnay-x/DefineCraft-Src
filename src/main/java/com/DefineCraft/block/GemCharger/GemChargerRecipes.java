...
public class GemChargerRecipes
{
    private static final GemChargerRecipes smeltingBase = new GemChargerRecipes();
     ...
     */
    public static final GemChargerRecipes Grinding()
    {
        return new GemChargerRecipes();
    }

    public GemChargerRecipes()
    {
